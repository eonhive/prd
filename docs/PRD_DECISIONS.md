...
**Follow-up:**  
Define fuller internal package layout rules later in `PRD_PACKAGE_LAYOUT_DRAFT.md`.
...
**Follow-up:**  
Define attachment classes and embedding/reference rules in `PRD_ASSETS_AND_ATTACHMENTS.md`.
...
**Follow-up:**  
Define profile-governance details in `PRD_PROFILE_REGISTRY.md` and add dedicated specs for canonical core profiles.
...
**Follow-up:**  
Add `PRD_LOCALIZATION_MODEL.md` and align manifest, capability, and architecture docs with localization as a cross-profile optional capability.
