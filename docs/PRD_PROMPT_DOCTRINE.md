...
3. `PRD_GLOSSARY.md`
4. `PRD_ROADMAP.md`
5. PRD history/archive docs, including `PRD_Project_History_Record.md`
6. the specific target doc being updated

If two sources conflict, the higher-priority source wins.

`PRD_SYSTEM_BLUEPRINT.md`, `PRD_MASTER_PROMPTS.md`, and prompt-local instructions may guide execution, but they must not override the priority order above.
