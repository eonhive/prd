...
40. [ ] Plan and implement the next small visual-profile import lane: ordered image folder to `comic` or `storyboard`, without broad conversion, Studio, Cloud, PRDc, payment, crypto, rights, or visual-editor scope.
